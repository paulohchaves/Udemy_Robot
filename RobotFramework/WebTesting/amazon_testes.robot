...
Caso de Teste 03 - Adicionar Produto no Carrinho      
    [Documentation]    Esse teste verifica adi çã o de um produto no carrinho de compras    
...
Caso de Teste 04 - Removedor Produto do Carrinho      
    [Documentation]    Esse teste verifica a remo çã o de um produto no carrinho de compras    
